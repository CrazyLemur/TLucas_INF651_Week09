...
function getAllParagraphs () {
    ...
    return myPageSection.getElementsByTagName("p");
}
...
function getTheListItem (num1, num2) {
    const unorderedList = document.getElementsByTagName("ul")[num1-1]; // subtract 1 to get correct index value
    const listItem = unorderedList.getElementsByTagName("li")[num2-1]; // subtract 1 to get correct index value
...
function changeBgColor (color) {
    const myPageSection = document.getElementById("myPage");
    myPageSection.style.backgroundColor = color;
